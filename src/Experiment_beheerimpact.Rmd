...
Ruigtes met nulbeheer breiden gemiddeld 52,4% uit per jaar, terwijl ruigtes met maaibeheergemiddeld 89,4% uitbreiden per jaar.
...
boxplot_O <- df %>%
  filter(begrensd == "0") %>% 
  ggplot(aes(x = beheer, y = logratio_jaar, fill = beheer), notch = TRUE) +
  geom_boxplot() +
