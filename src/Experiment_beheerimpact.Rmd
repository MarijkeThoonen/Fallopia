...
# we hermaken de figuur maar geven nu expliciet aan 
# welke waarden constant gehouden moeten worden:
...
p1 <- predictions(
  m1,
  newdata = datagrid(
    opp_m2_18 = c(1 , 5, 10, 50, 100, 500, 1000),
    beheer = c("nulbeheer", "maaibeheer")
  ),
  type = "link"
)
