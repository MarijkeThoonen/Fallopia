...
summary(fm1bis) # check de t-waarde bij maaibeheer = zelfde van de t-test, p-waarde is voor tweezijdige hypothese


fm2 <- gls( #een soort van lineair model gezien het verschil tussen varianties
  rel_uitbr_jaar ~ beheer, # beschrijving van het model, links de responsvariabele  ~ rechts de factorvariabele (+0 omdat er maar 1 factorvariabele is)
